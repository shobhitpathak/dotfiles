...
tags = {
  --names = { 1, 2, 3 },
  names = { "Ƅ", "ƈ", "Ɗ" },
  layout = { layouts[1], layouts[1], layouts[4] }
}
...
--vicious.register(pacman, vicious.widgets.pkg, "Arch")
...
awful.rules.rules = {
    ...
    { rule_any = { class = {"MPlayer", "gimp", "Gajim"} },
      properties = { floating = true } },
    { rule = { class = "Eclipse" },
      properties = { tag = tags[1][1] } },
    -- Disable drop shadow on non-floating windows
    { rule = { floating = false },
      properties = { role = "NO_SHADOW"} },
}
